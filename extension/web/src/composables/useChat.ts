...
export default function useChat() {
    ...
    async function sendMessage(retryOrExtra: boolean | Record<string, unknown> = false, retryMesIdx = 0, continue_ = false) {
        const retry = typeof retryOrExtra === 'boolean' ? retryOrExtra : false;
        const extraBodyFields = typeof retryOrExtra === 'object' && retryOrExtra !== null ? retryOrExtra : {};
